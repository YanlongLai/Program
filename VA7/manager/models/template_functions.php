...
function renderMenu($highlighted_item_class){
    ...
    if ($loggedInUser->user_id == $master_account){
        $hooks['#HEADERMESSAGE#'] = "<span class='navbar-center navbar-brand'>您目前以管理者身份登入</span>";
    } else {
      $hooks['#HEADERMESSAGE#'] = "<span class='navbar-center navbar-brand' style='color:#6D6E71;'> </span>";
    }
...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="../account/index.php"><img src=../../manager/images/CircleStar/CircleStar.png style=height:24px;padding-right:53px; class=img-responsive center-block ></a>
    #HEADERMESSAGE#
</div>

<div class="collapse navbar-collapse navbar-ex1-collapse" style="background:#efefef;">
    <!-- Collect the nav links, forms, and other content for toggling -->
    <ul class="nav navbar-nav side-nav" style="background:#efefef;font:#6D6E71;top:55px;">';
    foreach ($menu as $r => $v){
