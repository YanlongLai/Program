...
<html class="no-js" lang="">
	...
	<button type="button" class="btn btn-success" onclick="window.location.href='members.php'">回到粉圓資料</button>
	<hr>
  ...
  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
    <thead>
      <tr>
        ...
        <th style="width:20%" class="hidden-phone">粉圓等級</th>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <span class="image"><img src="http://placehold.it/50X50/CC2222/FFF" class="img-circle"></span>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <span class="image"><img src="http://placehold.it/50X50/11CC22/FFF" class="img-circle"></span>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <span class="image"><img src="http://placehold.it/50X50/EEEEEE/222" class="img-circle"></span>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <span class="image"><img src="http://placehold.it/50X50/1122CC/FFF" class="img-circle"></span>
        </td>
        <td>
